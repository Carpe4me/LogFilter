...
public class ThemeConstant {
    ...
    public static Color COLOR_TABLE_SELECTION_BG = UIManager.getColor("Table.selectionBackground");
    public static Color COLOR_TABLE_LOG_FLOW_SELECTION_BG = UIManager.getColor("Table.selectionBackground");
    ...
    public static Color COLOR_FIX_POPUP_BUTTON_BG = UIManager.getColor("Button.background").brighter();
    ...
    public static Color COLOR_LOG_TABLE_TEXT_DEBUG = new Color(104,151,187);
    ...
    public static Color COLOR_LOG_TABLE_CELL_BG_BOOKMARK = UIManager.getColor("Table.selectionBackground").brighter();
    public static Color COLOR_LOG_TABLE_CELL_BG_BOOKMARK_SELECTED = UIManager.getColor("Table.selectionBackground").brighter();
